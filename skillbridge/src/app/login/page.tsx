...
export default function LoginPage() {
  ...
  const validateForm = (): boolean => {
    ...
    if (!trimmed) {
      ...
      !mobileRegex.test(trimmed.replace(/\s/g, ''))
    ) {
  ...
  const t = {
    ...
    heading:
      lang === 'en'
        ...
        : 'SkillBridge में वापस स्वागत है',
    ...
    emailPlaceholder:
      lang === 'en'
        ...
        : 'you@example.com या +91 XXXXX XXXXX',
    ...
    roleAware:
      lang === 'en'
        ? 'Your account is role-aware'
        : 'आपका खाता भूमिका-आधारित है',

    returnToSkillBridge:
      lang === 'en'
        ? 'Return to SkillBridge'
        : 'SkillBridge पर वापस जाएं',
  };
  ...
  return (
    ...
    >
      <style>{`
        ...
        .sb-btn-primary:active:not(:disabled) {
      ...
      <div className="sb-login-root">
        ...
        <header className="sb-header">
          ...
          <div className="sb-header-right">
            ...
            <Link
              href="/"
              className="sb-return-link"
              aria-label="Return to SkillBridge homepage"
            >
          ...
          <div className="sb-center-col">
            ...
            <div className="sb-card">
              ...
              >
                ...
                <span className="sb-divider-text">
                  {t.orContinueWith}
                </span>
              ...
              <div className="sb-signup-row">
                ...
                <Link
                  href="/role?type=signup"
                  className="sb-signup-link"
                >
                  {lang === 'en'
                    ? 'Create your account →'
                    : 'अपना खाता बनाएं →'}
